...
hotelData = {
  TajBanjara: [17.40949249267578, 78.44866943359375],
}
...
const placeMarker = async() => {
  ...
  for (let loc of hotelNames) {
    ...
    aTag.innerHTML = "H";
    aTag.target = "_blank"
    aTag.href = "https://www.google.co.in/maps/place/17%C2%B024'34.2%22N+78%C2%B026'55.2%22E/@17.4094925,78.4460945,17z/data=!3m1!4b1!4m4!3m3!8m2!3d17.4094925!4d78.4486694?entry=ttu";
    aTag.title = loc;
    el.appendChild(aTag);
